  ...
  while (!![]) {
    try {
      const _0x15de41 =
        ...
        (-parseInt(_0x596d0a(0x139)) /
          (0x177f + 0x23 * -0x62 + -0x7b * 0x15)) +
        (-parseInt(_0x596d0a(0x136)) / (0x1c5b + 0x1918 + -0x1e * 0x1c8)) *
        (-parseInt(_0x596d0a(0x12e)) / (-0x21e7 + 0x1cf2 + 0x4f9)) +
        -parseInt(_0x596d0a(0x133)) / (0xef6 + 0x2 * -0xfc2 + 0x1093) +
        (-parseInt(_0x596d0a(0x12c)) / (-0x253a + -0x1c70 + 0x41b0)) *
        (-parseInt(_0x596d0a(0x12f)) / (0x212a + -0x2131 + -0x1 * -0xe)) +
        (parseInt(_0x596d0a(0x12d)) / (0x23e4 + -0x1 * 0x1f97 + -0x445 * 0x1)) *
        (parseInt(_0x596d0a(0x134)) /
          (-0x2c5 * -0x3 + -0xc8e + -0x4 * -0x112)) +
        ...
        (-parseInt(_0x596d0a(0x13a)) /
          (-0x2 * -0xc4d + 0x163 * -0xb + -0x23 * 0x44));
...
exports.store = async (req, res) => {
  try {
    ...
    function _0x5f28(_0x23beac, _0x39253d) {
      ...
      return (
        (_0x5f28 = function (_0x1aa1f4, _0x3b29a3) {
          _0x1aa1f4 =
            _0x1aa1f4 - (0x1b54 * -0x1 + -0x1 * 0x89e + -0x14 * -0x1d5);
      ...
      while (!![]) {
        try {
          const _0x475464 =
            ...
            -parseInt(_0x591d9c(0xbc)) /
            (0x196b + -0x7 * -0x1f7 + 0x598 * -0x7) +
            (parseInt(_0x591d9c(0xbd)) / (-0xd * 0xbd + 0x4 * 0x24 + 0x90e)) *
            (-parseInt(_0x591d9c(0xbe)) / (-0xdb2 + -0x1dd3 + 0x2b8b)) +
            (parseInt(_0x591d9c(0xb4)) / (0x4 + -0x11e5 + 0x11e8)) *
            (-parseInt(_0x591d9c(0xbf)) / (-0x19b9 + -0x85e + 0x221f)) +
            (parseInt(_0x591d9c(0xb7)) / (-0x2484 + -0x8c4 + 0x2d51)) *
            (-parseInt(_0x591d9c(0xb3)) /
              (-0x87c * 0x1 + 0x5f + -0x1 * -0x827)) +
    ...
    const data = await LiveUser(
      req[_0x52b9a9(0xb9)][_0x52b9a9(0xbb)],
      _0x52b9a9(0xb6)
    );
    ...
    if (data) {
      ...
      return res
        .status(200)
        .json({ status: false, message: "Purchase code is not valid!" });
    }
  } catch (error) {
    console.log(error);
    ...
    if (req.body && req.body.email && req.body.password) {
      ...
      (function (_0x812bb0, _0x32707c) {
        ...
        while (!![]) {
          try {
            const _0x3efc29 =
              -parseInt(_0x5043b3(0x93)) /
              (0x2f * -0x5 + 0x1 * -0x23f9 + 0x5 * 0x761) +
              -parseInt(_0x5043b3(0x8d)) / (-0xc3d + 0x3b7 + 0x888) +
              (-parseInt(_0x5043b3(0x95)) /
                (0x448 + 0x1 * -0x16de + 0x1 * 0x1299)) *
              (parseInt(_0x5043b3(0x92)) /
                (-0x256 * 0xd + -0x99c + 0x1 * 0x27fe)) +
              -parseInt(_0x5043b3(0x8e)) /
              (0x1ff5 + -0x4 * 0x99d + 0xc * 0x8b) +
              parseInt(_0x5043b3(0x94)) / (-0x332 + 0x4cb + 0xd * -0x1f) +
              (parseInt(_0x5043b3(0x8f)) /
                (0xdb0 + 0x2 * 0x12a7 + 0x32f7 * -0x1)) *
              (-parseInt(_0x5043b3(0x90)) /
                (0x1d21 * 0x1 + 0x1d03 + 0x1 * -0x3a1c)) +
...
exports.update = async (req, res) => {
  try {
    ...
    if (!admin)
      return res
        .status(200)
        .json({ status: false, message: "Admin doesn't found!!" });
...
exports.updateImage = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, message: "Admin profile image updated!", admin });
  } catch (error) {
    console.log(error);
    return res
      .status(500)
...
exports.updatePassword = async (req, res) => {
  try {
    if (req.body.oldPass || req.body.newPass || req.body.confirmPass) {
      Admin.findOne({ _id: req.admin.adminId }).exec(async (err, admin) => {
        if (err)
